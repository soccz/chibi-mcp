...
<p align="center">
  <img src="assets/social-preview.png?v=1.4.16-chibi" alt="chibi-mcp social preview showing the local MCP pet for Claude Code, Codex, and VS Code" width="720">
</p>
...
```bash
make release-check TAG=v1.4.16
```
...
<p align="center">
  <img src="docs/screenshots/starter-lineup.png?v=1.4.16-chibi" alt="chibi-mcp starter character lineup" width="720">
</p>

<p align="center">
  <img src="docs/screenshots/option-showcase.png?v=1.4.16-chibi" alt="chibi-mcp free option layers including syrup, glaze, powder, seeds, petals, resin stars, and sauce" width="720">
</p>
