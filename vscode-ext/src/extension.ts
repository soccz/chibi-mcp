...
.actions button:active { transform: translateY(0); box-shadow: inset 0 1px 2px rgba(0,0,0,0.2); }
#btn-gacha { background: linear-gradient(135deg, #ff6b9d, #ffd166); color: #24141a; border-color: #ff9dbd; }
